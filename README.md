...
https://covid.ourworldindata.org/data/ecdc/new_deaths.csv
 ...
 Blue line is the predicted curve using the last 280 days from Jan.22 in 2020. Red line based on the curve fitting with 5th degree polinomial is changing the size of days from 100 to 300 days from Jan.8 2021. Black line shows the number of daily deaths due to the covid-19 from Jan.22 to Jan.8 2021.
